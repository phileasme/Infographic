...
public class TextBoxController{
    ...
    public void setText(){
        ...
        ind1 = "IC.BUS.NREG"; ind2 = "IC.BUS.EASE.XQ";
        ind3 = "IC.REG.PROC"; ind4 = "IC.TAX.DURS";
        ind5 = "IC.REG.DURS";

        indicator1 = textviews.get(0); indicator2 = textviews.get(1);
        indicator3 = textviews.get(2); indicator4 = textviews.get(3);
...
//            data1double = 0.0;
//        }else{data1double = data1double - data1double%0.01;}
//        if(data2.equals("null")){
//            data2double = 0.0;
//        }else{data2double = data2double - data2double%0.01;}
//        if(data3.equals("null")){
//            data3double = 0.0;
//        }else{data3double = data3double - data3double%0.01;}
//        if(data4.equals("null")){
//            data4double = 0.0;
//        }else{data4double = data4double - data4double%0.01;}
//        if(data5.equals("null")){
//            data5double = 0.0;
//        }else{data5double = data5double - data5double%0.01;}
//        if(data6.equals("null")){
//            data6double = 0.0;
//        }else{data6double = data6double - data6double%0.01;}
//        if(data7.equals("null")){
//            data7double = 0.0;
//        }else{data7double = data7double - data7double%0.01;}
//        if(data8.equals("null")){
//            data8double = 0.0;
//        }else{data7double = data7double - data7double%0.01;}
//        if(data9.equals("null")){
//            data9double = 0.0;
//        }else{data9double = data9double - data9double%0.01;}
//        if(data10.equals("null")){
//            data10double = 0.0;
//        }else{data10double = data10double - data10double%0.01;}
//    }
